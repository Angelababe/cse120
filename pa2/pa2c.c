 ...
 * For example, given four processes 1, 2, 3, 4, then the output should
...
void Main()
{
	if (Fork() == 0) {
    					// process 2
    RequestCPUrate(20);
		SlowPrintf(1, "222222222222222222");
if (Fork() == 0) {
    
					// process 4
			SlowPrintf(1, "444444444444444444");
			Exit();
		}
    SlowPrintf(1, "22222");
		Exit();
	...
	/*if (Fork() == 0) {
						...
						// process 3
		SlowPrintf(1, "333333333333333333");
    RequestCPUrate(40);
    SlowPrintf(1, "33333333333333333");
		Exit();
	}*/

	RequestCPUrate(10);					// process 1
	SlowPrintf(1, "1111111111111111111111111111111111");
	Exit();
}
