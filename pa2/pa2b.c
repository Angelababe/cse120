...
if(Fork() == 0){
      SlowPrintf(2, "13,13,13");
      Exit();
    }
      SlowPrintf(2, "12,12,12");
      Exit();
    }

      SlowPrintf(2, "11,11,11");
      Exit();
    }
      SlowPrintf(2, "10101010");
      Exit();
    }
      SlowPrintf(2, "9999999999");
      Exit();
    }
      SlowPrintf(2, "8888888888");
      Exit();
    }
      SlowPrintf(2, "7777777777");
      Exit();
    }
      SlowPrintf(2, "6666666666");
      Exit();
    }
      SlowPrintf(2, "5555555555");
      Exit();
    }
/*if (Fork() == 0) {

      SlowPrintf(2, "14,14,14");
      Exit();
    }*/
